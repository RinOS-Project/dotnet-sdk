...
internal partial class ExternalHelpers
{
    ...
    public static partial int CombineHashCodes(int value1, int value2)
        => throw new NotSupportedException("The netstandard2.0 source package requires the consumer to provide CombineHashCodes.");

    public static partial string GetRelativePath(string relativeTo, string path)
        => throw new NotSupportedException("The netstandard2.0 source package requires the consumer to provide GetRelativePath.");

    public static partial bool IsPathFullyQualified(string path)
        => throw new NotSupportedException("The netstandard2.0 source package requires the consumer to provide IsPathFullyQualified.");
