...
internal class Layer
{
    ...
    private sealed class LayerTarGZipStream : Stream
    {
        ...
        // Preserve the same normalization and digest path for callers that use Stream's async API.
        ...
        public override long Length => throw new NotSupportedException("Layer tar stream is write-only and non-seekable.");
        public override long Position
        {
            get => throw new NotSupportedException("Layer tar stream is write-only and non-seekable.");
            set => throw new NotSupportedException("Layer tar stream is write-only and non-seekable.");
        }

        public override int Read(byte[] buffer, int offset, int count)
            => throw new NotSupportedException("Layer tar stream is write-only.");
        public override long Seek(long offset, SeekOrigin origin)
            => throw new NotSupportedException("Layer tar stream is non-seekable.");
